...
def main():
    ...
    print("dirPath", dirPath, "maxZipFileSize", maxZipFileSize, "all_books count: ", len(all_books))
    ...
    while bookIndex < len(all_books):
        ...
        log_str = "zipfillename: {},  curZipFileCount: {}, totalFileCount: {}, spendTime: {}".format(zipfillename, curZipFileCount, totalFileCount, int(cur_time-begin_time))
